const Projects = () => {
    return (
        <div className='projects' id='projects'>
          ...
          <button className="project-btn"><a href="https://github.com/ItsAnyaS/POS" target='_blank'>Repo</a></button>
          <button className="project-btn"><a href="https://point-of-sale.herokuapp.com/" target='_blank'>View Site</a></button>
          ...
          <button className="project-btn"><a href="https://github.com/ItsAnyaS/Callbck" target='_blank'>Repo</a></button>
          <button className="project-btn"><a href="https://callbck.herokuapp.com/" target='_blank'>View Site</a></button>
              </div>
          ...
          <button className="project-btn"><a href="https://github.com/ItsAnyaS/banana" target='_blank'>Repo</a></button>
              </div>
