...
return (
   ...
   <a href='https://www.linkedin.com/in/anastasiasirman/' target='_blank'><ion-icon name="logo-linkedin"></ion-icon></a>
   <a href='https://github.com/itsAnyaS' target='_blank'><ion-icon name="logo-github"></ion-icon></a>
